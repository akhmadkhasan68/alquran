	...
	function frm_cari(){
		...
		<form method='post' name='frm_cari' action='?mod=hadits.pencarian.show&cari=1'>
			<table align='center' class='frm_cari' border='0'>
				<tr>
					<td width='15%'>Kitab</td> 
					<td width='5%'>:</td> 
					<td width=''>
						".combobox($_SESSION[kitab]," onchange='frm_cari.submit()' ","cmb_kitab",$arr_value_kitab,$arr_title_kitab)."
					</td>
				</tr>
				<tr>
					<td width='15%'>Bab / Tema</td> 
					<td width='5%'>:</td> 
					<td width=''>
				...
				<tr>
					<td width='15%' valign='top'>Kata Kunci Isi</td> 
					<td width='5%' valign='top'>:</td> 
					<td width=''>
						<textarea class='form-control' name='txa_isi'"
				...
				<tr>
					<td colspan='3'>
						<input type='submit' value='OK' class='btn btn-block btn-info'>
					</td>
				</tr>
			</table>
		</form>
